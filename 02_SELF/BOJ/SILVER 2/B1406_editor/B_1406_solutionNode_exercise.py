...
class Editor:
    ...
    # head - n_node
    # head - new_node - n_node
    def insert_right_head(self, c):
        new_node = NODE(c)
    ...
    # head - del_node - n_node
    # head - n_node
    # if del_node == cursor :  cursor 를 앞으로 이동은 못함. cursor는 head 일 수 없음
    def delete_right_head(self):
...
print(editor)
editor.insert_right_head('A')
editor.insert_right_head('B')
print(editor)
editor.delete_right_head()
print(editor)
# insert_right_head(c)
# delete_right_head()
# search_node(c)
